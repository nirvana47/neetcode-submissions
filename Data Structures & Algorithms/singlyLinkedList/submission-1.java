class LinkedList {
    ...
    public int get(int index) {
        ...
        // If LinkedList is not empty, and looking for the
        // first element, return the head's value
        if (index == 0)
            return head.val;
        
        // If LinkedList is not empty, and the index is not the
        // first element, then let's go through the list
        Node cur = new Node();
        cur = head;
